...
Vue.mixin({
  computed: {
    ...
    $showAlert: {
      get: function() {
        return globalData.$data.$showAlert;
      },
      set: function(showAlert) {
        globalData.$data.$showAlert = showAlert;
      }
    },
    $hasChange: {
      get: function() {
        return globalData.$data.$hasChange;
      },
      set: function(hasChange) {
        globalData.$data.$hasChange = hasChange;
      }
    },
    $IsVerified: {
      get: function() {
        return globalData.$data.$IsVerified;
      },
      set: function(IsVerified) {
        globalData.$data.$IsVerified = IsVerified;
      }
    },
    $forceRefresh: {
      get: function() {
        return globalData.$data.$forceRefresh;
      },
      set: function(forceRefresh) {
        globalData.$data.$forceRefresh = forceRefresh;
      }
    },
  }
});
...
Vue.prototype.$headers = {
  ...
  Authorization: VueCookies.isKey("seller-token")
    ? `Bearer ${VueCookies.get("seller-token")}`
    : "null"
};
